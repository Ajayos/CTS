...
async function yt(url, quality, type, bitrate, server = 'en68') {
    //var u_rl = ''
    ////if(url.startsWith('https://youtube.com/watch?v=') || url.startsWith('https://youtu.be/') || url.startsWith('https://youtube.com/')) return false;
    //if(url.startsWith('https://youtube.com/watch?v=')) {
    //    u_rl = url.split('https://youtube.com/watch?v=')[1];
    //} else if (url.startsWith('https://youtube.com/shorts/')) {
    //    u_rl = url.split('https://youtube.com/shorts/')[1];
    //} else if(url.startsWith('http://youtu.be/')) {
    //    u_rl = url.split('https://youtu.be/')[1];
    //} else if(url.startsWith('https://www.youtube.com/watch?v=')) {
    //    u_rl = url.split('https://www.youtube.com/watch?v=')[1];
    //} else if(url.startsWith('https://www.youtube.com/shorts/')) {
    //    u_rl = url.split('https://www.youtube.com/shorts/')[1];
    //} else if(url.startsWith('http://www.youtu.be/')) { 
    //    u_rl = url.split('https://www.youtu.be/')[1];
    //}
    const ur_l = 'https://youtu.be/' + url;
...
yt('pd3WwcQwOpk', '128kbps',  'mp3', '128', server = 'en68') 
